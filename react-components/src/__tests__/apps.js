...
it('renders CategoryTree without crashing', () => {
    ...
    ReactDOM.render(<MuiThemeProvider theme={getDefaultTheme()}><CategoryTreeTest/></MuiThemeProvider>,
        div);
...
it('renders AppDetails without crashing', () => {
    ...
    ReactDOM.render(<MuiThemeProvider
        theme={getDefaultTheme()}><AppDetailsTest/></MuiThemeProvider>, div);
    ReactDOM.unmountComponentAtNode(div);
});
...
it('renders AppDoc without crashing', () => {
    const div = document.createElement('div');
    ReactDOM.render(<MuiThemeProvider theme={getDefaultTheme()}><AppDocTest/></MuiThemeProvider>, div);
    ReactDOM.unmountComponentAtNode(div);
});
...
it('renders AppInfoDialog without crashing', () => {
    const div = document.createElement('div');
    ReactDOM.render(<MuiThemeProvider theme={getDefaultTheme()}><AppInfoDialogTest/></MuiThemeProvider>,
        div);
    ReactDOM.unmountComponentAtNode(div);
});
