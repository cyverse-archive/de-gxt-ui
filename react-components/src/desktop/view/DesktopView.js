        ...
        return (
            <div className={css(styles.body)}>
                        ...
                        <span className={css(styles.userMenuContainer)}>
                            <nav>
                                ...
                                <span id={build(ids.DESKTOP, ids.USER_MENU_ANCHOR)}
                                      className={css(styles.userMenuPosition)}/>
                                <span id={build(ids.DESKTOP, ids.HELP_MENU_ANCHOR)}
                                      className={css(styles.helpMenuPosition)}/>
                            </nav>
                        </span>
                    </div>
                </div>
                <div id={this.props.desktopContainerId} className={css(styles.desktop)}>
                    ...
                    <img className={css(styles.analyses)}
...
export default withI18N(DesktopView, intlData);