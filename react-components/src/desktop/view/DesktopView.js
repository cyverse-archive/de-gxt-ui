...
class DesktopView extends Component {
    ...
    handleDesktopClick(event) {
        ...
        windows.push(id);
        switch (id) {
            case ids.desktop + ids.dataBtn:
                this.props.presenter.onDataWinBtnSelect();
                break;
            case ids.desktop + ids.appsBtn:
                this.props.presenter.onAppsWinBtnSelect();
                break;
            case ids.desktop + ids.analysesBtn:
            ...
            <div className={css(styles.body)}>
                <div className={css(styles.header)}>
                    <div className={css(styles.logo)}>
                        <span className={css(styles.logoContainer)}>CyVerse Discovery Environment</span>
                        <span className={css(styles.userMenuContainer)}>
                            <nav>
                                <Notifications {...intlData}
                                ...
                                <span id="notificationMenuAnchor"
                                      className={css(styles.notificationMenuPosition)}/>
                                <span id="userMenuAnchor" className={css(styles.userMenuPosition)}/>
                                <span id="helpMenuAnchor" className={css(styles.helpMenuPosition)}/>
                            </nav>
                        </span>
                    </div>
                </div>
                <div className={css(styles.desktop)}>
                    <img className={css(styles.data)} id={ids.desktop + ids.dataBtn} onClick={this.handleDesktopClick}
                    ...
                    <img className={css(styles.apps)} id={ids.desktop + ids.appsBtn} onClick={this.handleDesktopClick}
                    ...
                    <img className={css(styles.analyses)} id={ids.desktop + ids.analysesBtn}
