const intlData = {
    ...
    messages: {
        ...
        joinRequestIntro:
            "The following user has requested to join a team you currently manage.  As an administrator to the team, you can either approve or deny the request.",
        denyRequestMessage:
            "By clicking OK, you are notifying {name} that his/her request to join {team} has been denied.  You can optionally add a short message to attach to the notification below.",
        ...
        setPrivilegesText:
            "Please select which team privileges you would like to assign to {name} within {team}",
        teamLabel: "Team",
        denyRequestSuccess:
            "Message successfully sent to {name} denying their request to join {team}",
