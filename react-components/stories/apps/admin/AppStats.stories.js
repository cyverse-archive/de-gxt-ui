...
class AppStatsTest extends Component {
    render() {
            ...
            apps: [
                {
                    ...
                    pipeline_eligibility: {
                        is_valid: false,
                        reason:
                            "Job type, fAPI, can't currently be included in a pipeline.",
                    },
                    is_favorite: false,
                ...
                },
                {
                    ...
                    description:
                        "Takes any fasta file for a reference, builds the index and then maps reads to the index. The index is saved in tar.gz form. Colorspace toolStatusHelpMapping is not available in this version, but this version maps much longer read sequences. ",
                    deleted: false,
                    pipeline_eligibility: {
                        is_valid: true,
                        reason: "",
                ...
                },
                {
                    ...
                    description:
                        "This App runn Cufflinks (version 2+) to assemble transcripts using Sequence alignments (BAM) generated by TopHat/Bowtie.",
                    deleted: false,
                    pipeline_eligibility: {
                        is_valid: true,
                        reason: "",
                ...
                },
                {
                    ...
                    description:
                        "TopHat 2.0.9 (for single-end reads) is a fast splice junction mapper for RNA-Seq reads. It aligns RNA-Seq reads to mammalian-sized genomes using the short read aligner Bowtie and analyzes the toolStatusHelpMapping results to identify splice junctions between exons. ",
                    deleted: false,
                    pipeline_eligibility: {
                        is_valid: true,
                        reason: "",
        ...
        return <AppStats presenter={presenter} />;
    }
}
