...
import AdminAppGridListing from "../../../src/apps/admin/AdminAppsGridListing";

class AdminAppGridListingTest extends Component {
    render() {
        const apps = [
            {
...
export default AdminAppGridListingTest;
