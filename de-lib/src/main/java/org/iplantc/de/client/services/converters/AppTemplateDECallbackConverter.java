 ...
 * @author jstroot
 */
public class AppTemplateDECallbackConverter extends DECallbackConverter<String, AppTemplate> {

    private final AppTemplateAutoBeanFactory factory;
    private final AppTemplateUtils appTemplateUtils;

    public AppTemplateDECallbackConverter(AppTemplateAutoBeanFactory factory,
