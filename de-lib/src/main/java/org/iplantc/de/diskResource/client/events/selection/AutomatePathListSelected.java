...
public class AutomatePathListSelected
    ...
    private final InfoType pathListInfoType;

    public InfoType getPathListInfoType() {
        return pathListInfoType;
    }
    ...
    public AutomatePathListSelected(InfoType pathListInfoType) {
