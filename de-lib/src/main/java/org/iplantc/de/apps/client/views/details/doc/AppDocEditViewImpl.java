 ...
 * @author jstroot
 */
public class AppDocEditViewImpl extends Composite implements AppDocEditView,
                                                             IsMaskable {

    @UiTemplate("AppDocEditViewImpl.ui.xml")
    interface AppDocEditViewUiBinder extends UiBinder<Widget, AppDocEditViewImpl> { }
    ...
    @Inject
    public AppDocEditViewImpl(@Assisted final App app,
                              @Assisted final AppDoc appDoc) {
        this.app = app;
    ...
    public static native JavaScriptObject displayData(final AppDocEditViewImpl instance,
                                                      XElement textArea,
                                                      String editorMode,
                                                      String val,
                                                      int width,
		...
		myCodeMirror
				.on(
						"change",
						$entry(function() {
							instance.@org.iplantc.de.apps.client.views.details.doc.AppDocEditViewImpl::setDirty(Ljava/lang/Boolean;)(@java.lang.Boolean::TRUE);
						}));
		return myCodeMirror;
    }-*/;
